    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                out = setTimeout(function () { return controller.abort(); }, timeout);
                _a.label = 1;
            case 1:
                _a.trys.push([1, , 3, 4]);
                if (url.startsWith('file://'))
                    return [2 /*return*/, fs.readFile(new url_1.URL(url), { signal: controller.signal })];
                return [4 /*yield*/, (0, node_fetch_1.default)(url, { signal: controller.signal })];
            case 2:
                res = _a.sent();
                if (!res.ok)

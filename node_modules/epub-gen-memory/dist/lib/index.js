...
exports.EPub = exports.optionsDefaults = exports.chapterDefaults = void 0;
...
var EPub = /** @class */ (function () {
    function EPub(options, content) {
        ...
        if (this.options.cover) {
            var fname = (0, util_1.isString)(this.options.cover) ? this.options.cover : this.options.cover.name;
            var mediaType = (0, mime_1.getType)(fname);
            var extension = (0, mime_1.getExtension)(mediaType || '');
            if (mediaType && extension)
                this.cover = { mediaType: mediaType, extension: extension };
            else
                this.warn('Could not detect cover image type from file', fname);
        }
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        oebps = this.zip.folder('OEBPS');
                        if (!(0, util_1.isString)(this.options.cover)) return [3 /*break*/, 2];
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 5];
                    case 2:
                        if (!(typeof this.options.cover.arrayBuffer !== 'undefined')) return [3 /*break*/, 3];
                        oebps.file("cover.".concat(this.cover.extension), this.options.cover.arrayBuffer());
                        return [3 /*break*/, 5];
                    case 3:
                        ...
                        reader_1.readAsArrayBuffer(this.options.cover);
                        return [4 /*yield*/, promise];
                    case 4:
                        _a.sent();
                        coverContent = reader_1.result;
                        oebps.file("cover.".concat(this.cover.extension), coverContent);
                        _a.label = 5;
...
var epub = function (optionsOrTitle, content) {
    ...
    (0, util_1.validateIsOptionsOrTitle)(optionsOrTitle);
    var options = (0, util_1.isString)(optionsOrTitle) ? { title: optionsOrTitle } : optionsOrTitle;
    (0, util_1.validateIsVarargArray)(args);
